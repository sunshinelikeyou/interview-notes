...
export default defineConfig({
  ...
  themeConfig: {
    ...
    editLink: {
      pattern:
        "https://github.com/sunshinelikeyou/interview-notes/blob/master/:path",
    },
    ...
    sidebar: [
      {
        items: [{ text: "介绍", link: "/src/introduce.md" }],
      },
      {
        text: "技术栈",
        collapsed: false,
        items: [
          ...
          { text: "Shell", link: "/src/shell.md" },
          {
            text: "软考(软件设计师)",
            link: "/src/software-examination.md",
          },
        ],
      },
    ],
    ...
    socialLinks: [
      {
        icon: "github",
        link: "https://github.com/sunshinelikeyou/interview-notes",
      },
      {
        icon: {
